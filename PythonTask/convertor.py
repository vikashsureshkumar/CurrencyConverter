...
def getAllTransactionRequests(path):
    ...
    # allTransactionRequests.append(TransactionRequest(CSVAdapter()).transactionRequests(json_files))
    # allTransactionRequests.append(TransactionRequest(CSVAdapter()).transactionRequests(xml_files))
